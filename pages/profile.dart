...
class _ProfileState extends State<Profile> {
  ...
  UploadItem() async {
    ...
    if (selectedImage != null) {
      ...
      var downloadUrl =
          await (await task).ref.getDownloadURL(); //saves user profile
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Column(
                              //help to put the text/object to the right side
